...
---------------------------------------------------------------------------------------------
-- 1.b Schritt: Mautpunkte vorbereiten
---------------------------------------------------------------------------------------------

---------------------------------------------------------------------------------------------
-- Zwischenschritt Mauttabelle zu Mautknoten vorbereiten mit Mulitpoints:
---------------------------------------------------------------------------------------------
...
UPDATE import.mautknoten as m set geom = ST_COLLECT(ST_SetSRID(ST_MakePoint(m.lon_von, m.lat_von), 3857), ST_SetSRID(ST_MakePoint(m.lon_bis, m.lat_bis), 3857))
